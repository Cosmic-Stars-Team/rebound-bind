...
fn build(manifest_dir: &Path, version: &str) {
    ...
    if is_windows {
        cc_build.define("BUILDINGLIBREBOUND", None);
        ...
        cc_build.flag_if_supported("-Wpedantic");
        cc_build.flag_if_supported("-Wno-strict-prototypes");
        cc_build.flag_if_supported("-Wextra");
